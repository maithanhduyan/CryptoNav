...
def get_directory_tree(root_dir, exclude_dirs=None, exclude_files=None, prefix=""):
    ...
    # Loại trừ các thư mục và tệp không mong muốn
...
if __name__ == "__main__":
    ...
    root_dir = os.path.join("..", "fastapi")  # Thư mục gốc của dự án
    output_file = os.path.join(".", ".tools", "project_structure.md")
    extensions = ["py"]  # Danh sách các phần mở rộng tệp
    filenames = ["Dockerfile", "requirements.txt"]  # Danh sách các tên tệp cụ thể
    exclude_dirs = [
        "node_modules",
        "pylinux",
        "data",
